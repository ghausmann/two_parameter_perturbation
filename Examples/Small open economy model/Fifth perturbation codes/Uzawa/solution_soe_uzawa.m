...
%interest:
psi2_calib = compute_betta_soe_uzawa(P1,b_bar,model,params,M,nxss0,nyss,eps_ind,approx0,0)
params(12) = psi2_calib;
%Just a check
b1_check = compute_sss_soe_uzawa(P1,model,params,M,nxss0,nyss,eps_ind,approx0,0);
...
%--------------------------------------------------------------------------
% Simulation of the pure Uzawa model (eps=0)
%--------------------------------------------------------------------------

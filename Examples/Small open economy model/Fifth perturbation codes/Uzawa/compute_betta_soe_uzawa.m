function y = compute_betta_soe_uzawa(P,b1,model,params,M,nxss0,nyss,eps_ind,approx,guess)
...
%function:
my_evalf= @(x)calib_sss_soe_uzawa(x,b1,model,params,M,eta,nxss0,nyss,eps_ind,approx);

...
%DSS of exogenous states, and controls
...
my_sss_2 = compute_sss_soe_uzawa([ty 0],model,params,M,nxss0,nyss,eps_ind,2,0)
my_sss_3 = compute_sss_soe_uzawa([ty 0],model,params,M,nxss0,nyss,eps_ind,3,0)
my_sss_4 = compute_sss_soe_uzawa([ty 0],model,params,M,nxss0,nyss,eps_ind,4,0)
my_sss_5 = compute_sss_soe_uzawa([ty 0],model,params,M,nxss0,nyss,eps_ind,5,0)
...
for t=1:lty
    ...
    bsss_sy(t) = compute_sss_soe_uzawa([mty(t) 0],model,params,M,nxss0,nyss,eps_ind,approx,guess_b);
    guessb = bsss_sy(t);
...
for t=1:lg
    ...
    params(2) = mgama(t);
    bsss_g(t) = compute_sss_soe_uzawa([ty 0],model,params,M,nxss0,nyss,eps_ind,2,guess_b);
    guessb = bsss_g(t);
...
figure;
subplot(1,2,1);
plot(mty,bsss_sy,'g');title('income risk');
subplot(1,2,2);

...
eval_sss_soe_uzawa_dynare.m: function to implement the algorithm described in Section 2.4 of the paper.
calib_sss_soe_uzawa_dynare.m: function to implement the algorithm described in Section 2.4 of the paper, in calibration mode.

compute_sss_soe_uzawa_dynare.m: function to approximate the SSS of bonds.
compute_beta_soe_uzawa_dynare.m: function to calibrate pssi2_star consistnat with a target SSS of bonds.
...
solution_soe_uzawa_dynare.m: scrpit to compute Euler equation errors and kernel distributions.

...
% This script replicates (part of) Figure 6 of Appendix E, from the paper:
...
for t=1:l_mtd
    ...
    sol_mtd(t) = compute_sss_dsge2(M_,options_,oo_,eps_ind,0.5);
...
for t=1:l_mtq
    ...
    % this function computes the SSS of equities
    sol_mtq(t) = compute_sss_dsge2(M_,options_,oo_,eps_ind,0.5);

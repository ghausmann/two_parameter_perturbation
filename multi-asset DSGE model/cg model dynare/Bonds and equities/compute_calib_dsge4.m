function y = compute_calib_dsge4(a1,M_,options_,oo_,eps_ind,guess)
...
% equities.
% Inputs are a1 (target SSS of equities), Dynare's structs, eps_ind (index of the epsilon variable), and
% a initial guess.
...
my_evalf= @(x)calib_sss_dsge4(x,a1,M_, options_, oo_,eps_ind);

...
simul_linear_risk.m: function, heavily modified version of the original function "simul.m"by Levintal (2017). Implements a pruned simulation using linear risk-corrected rules.

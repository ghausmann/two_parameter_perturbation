...
solution_dsge4_compstats.m: script to perform comparative statics (Figure 1).
solution_dsge4_simul.m: script to generate the stochastic simulation (Table 2, columns 1-3).

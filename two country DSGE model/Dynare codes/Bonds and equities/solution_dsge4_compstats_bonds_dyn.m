...
% This script replicates (part of) Figure 11 in Appendix E.
%
...
for t=1:l_mtd
    ...
    sol_mtd(t,:) = compute_sss_dsge4_dyn(M_,options_,oo_,eps_ind,[1 1]);
...
for t=1:l_mtq
    ...
    M_.params(17) =mtq(t);
    sol_mtq(t,:) = compute_sss_dsge4_dyn(M_,options_,oo_,eps_ind,guess);
